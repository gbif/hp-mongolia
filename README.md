...
[![Build Status](https://builds.gbif.org/job/hp-mongolia/badge/icon)](https://builds.gbif.org/job/hp-mongolia/lastBuild/console)
...
# GBIF Hosted Portal: mongolia

This Jekyll website, **[mongolia (Staging)](https://mongolia.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
